...
export class LockComponent implements OnInit , AfterViewInit {
  ...
  mapClick(Device){
      ...
      let content = `<div style="min-width:200px;font-size:13px;color:black;">
  ...
  addMarker(device) {
    ...
    const type = device.device_type;
        ...
        //     image: status == 3 ? '../../../assets/img/suo_gj.png' :
    ...
    const status = device.device_status;
        ...
        let content = '';
            content = `<div style="min-width:200px;font-size:13px;color:black;">
                          ...
                          <p>最后上报时间:${Device.uploaded_at}</p>
                          <p>
                            <button style="padding:3px 5px;background:#1ab394;color:#fff;border-radius:3px;">开启</button>
                          </p>
                       </div>
                      `
